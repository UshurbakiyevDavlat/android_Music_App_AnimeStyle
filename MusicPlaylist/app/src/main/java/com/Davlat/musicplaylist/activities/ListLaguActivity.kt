package com.Davlat.musicplaylist.activities
...
import com.Davlat.musicplaylist.R
import com.Davlat.musicplaylist.adapter.ListLaguAdapter
import com.Davlat.musicplaylist.adapter.ListLaguAdapter.onSelectData
import com.Davlat.musicplaylist.model.ModelListLagu
import com.Davlat.musicplaylist.networking.Api
...
class ListLaguActivity : AppCompatActivity(), onSelectData {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressDialog!!.setTitle("Открытие")
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) {
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(
                            this@ListLaguActivity,
                            "Не возможно загрузить данные", Toast.LENGTH_SHORT
                        ).show()
                    }
                }
                ...
                override fun onError(anError: ANError) {
                    ...
                    Toast.makeText(
                        this@ListLaguActivity,
                        "Ошибка при подключении!", Toast.LENGTH_SHORT
                    ).show()
                }
            })
    }
